...
class __TwigTemplate_737573649618dd35e698e604cbcde66fed4d4f4bd41670ca0a2803bfd434061e extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 6
        echo "    <h1>Recherche des réservation</h1>
    ...
    <table class=\"table\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["reservation"]) {
            ...
            echo "</td>
                <td>";
            // line 23
            ((twig_get_attribute($this->env, $this->source, $context["reservation"], "date_vol", [], "any", false, false, false, 23)) ? (print (twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, $context["reservation"], "date_vol", [], "any", false, false, false, 23), "D d F Y à H:i"), "html", null, true))) : (print ("")));
            echo "</td>
                <td>";
            // line 24
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["reservation"], "duree_vol", [], "any", false, false, false, 24), "html", null, true);
            echo "</td>
                <td>";
            // line 25
    ...
    {
        return array (  159 => 41,  150 => 37,  140 => 32,  135 => 30,  128 => 26,  124 => 25,  120 => 24,  116 => 23,  112 => 22,  109 => 21,  104 => 20,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block body %}
    <h1>Recherche des réservation</h1>
    ...
    <table class=\"table\">
        ...
        {% for reservation in result %}
            <tr>
                ...
                <td>{{ reservation.date_vol ? reservation.date_vol|date('D d F Y à H:i') : '' }}</td>
                <td>{{ reservation.duree_vol }}</td>
    ...
    {#    {{ form(form) }}#}
{% endblock %}
", "search/index.html.twig", "/home/michel/Documents/CNAM/UTC504_MERISE_UML/Projet/airclub_manager/templates/search/index.html.twig");
    }
}
