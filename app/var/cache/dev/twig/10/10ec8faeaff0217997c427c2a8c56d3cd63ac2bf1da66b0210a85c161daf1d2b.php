...
class __TwigTemplate_67ab70ccb826dcf5238a5a8ff1918ec527b3e7616109d66efe9ad951096da9e8 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("<form method=\"post\" action=\"{{ path('reservation_delete', {'id': reservation.id}) }}\"
      onsubmit=\"return confirm('Are you sure you want to delete this item?');\">
    <input type=\"hidden\" name=\"_method\" value=\"DELETE\">
    <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('delete' ~ reservation.id) }}\">
    <button class=\"btn btn-danger\">Delete</button>
</form>
", "reservation/_delete_form.html.twig", "/home/michel/Documents/CNAM/UTC504_MERISE_UML/Projet/airclub_manager/templates/reservation/_delete_form.html.twig");
    }
}
